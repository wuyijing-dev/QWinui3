...
Library **v1.80**. Generated from QML source comments (`scripts/generate_component_docs.py`).
...
- [OnScreenKeyboard](components/OnScreenKeyboard.md) — Win11 touch-keyboard chrome + layouts (1.80). · Gallery
