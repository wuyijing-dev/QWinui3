...
| [`on-screen-keyboard.md`](on-screen-keyboard.md) | Win11 OSK → IME (1.70…**1.77**; still experimental at **1.78**) |
| [`checkpoint-178.md`](checkpoint-178.md) | Long-horizon 1.xx checkpoint (**1.78**) |
