...
| **On-screen keyboard** | `OnScreenKeyboard` / `KeyboardEngine` / `ImeCandidateBar` | Win11 OSK + zh/ja/ko IME (**1.73**); still experimental — [on-screen-keyboard.md](on-screen-keyboard.md) |
