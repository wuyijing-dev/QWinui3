...
Library **v3.56**. Python packages that load the **same QML controls** as C++ apps — shared kit (`qml/` + native plugins) + bootstrap helpers.
...
**2** packages · **35** functions · **3** classes · **3** QML-registered types.
