...
`import QWinUI3.Extras.Charts` · [`src/extras/QWinUI3/Extras/ErrorBarChart.qml`](https://github.com/wuyijing-dev/QWinui3/blob/master/src/extras/QWinUI3/Extras/ErrorBarChart.qml)
