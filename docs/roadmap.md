...
**1.xx close-out:** [checkpoint-190.md](checkpoint-190.md). **1.86…1.89** performance arc **signed off** (**animations stay**). OSK/packaging **2.01+**. **Do not implement 2.00 before 1.90 ships.**  
...
| [docs/checkpoint-190.md](checkpoint-190.md) | 1.90 1.xx close-out + perf arc sign-off |
