...
- Extend [graphics-backend.md](graphics-backend.md): recommended backends per OS, alpha/backdrop caveats, `--rhi` / Settings restart story.
...
- Re-test StandardWindow / ShellWindow / Mica / Acrylic / Solid on Win + Linux; refresh [window-chrome.md](window-chrome.md) / [window-shells.md](window-shells.md).
...
- `docs/tree-data.md` (or extend [data-collections.md](data-collections.md)); Gallery polish.
...
- Update [stable-api.md](stable-api.md) + Gallery badges.
