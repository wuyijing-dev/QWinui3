...
**Current:** **3.35** (master — deferred Charts / OSK / WebView2 QML modules)
**Next up:** **3.36** cold start (import graph) · **3.00** close-out still open ([checkpoint-300](checkpoint-300.md)) · [tranche 10 → 4.00](../ROADMAP.md#efficiency--control-depth-tranche-10-334--400)
