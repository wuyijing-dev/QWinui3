...
**Next up:** **3.42** memory (Theme / singleton trim) · **3.00** close-out still open ([checkpoint-300](checkpoint-300.md)) · [tranche 10 → 4.00](../ROADMAP.md#efficiency--control-depth-tranche-10-334--400)
