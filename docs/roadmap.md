...
**Current:** **3.34** (master — Bootstrap cold path / deferred icon catalog)
**Next up:** **3.35** cold start (QML registration) · **3.00** close-out still open ([checkpoint-300](checkpoint-300.md)) · [tranche 10 → 4.00](../ROADMAP.md#efficiency--control-depth-tranche-10-334--400)
