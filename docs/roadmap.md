...
**Still 1.xx until 1.90:** Long-horizon checkpoint — [docs/checkpoint-178.md](checkpoint-178.md). **1.86…1.88** perf waves shipped. **1.89** continues the arc (**animations stay**). OSK/packaging **2.01+**. **Do not implement 2.00 before 1.90.**  
