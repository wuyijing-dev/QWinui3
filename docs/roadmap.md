...
- Minimal consumer `CMakeLists.txt` / qmake-or-Qt Creator kit notes; link from README + [qt-creator.md](qt-creator.md).
...
**Why:** 1.02 covered the high-traffic path; [accessibility.md](accessibility.md) still tracks Medium/Low gaps.
