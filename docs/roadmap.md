...
**Still 1.xx until 1.90:** Long-horizon checkpoint — [docs/checkpoint-178.md](checkpoint-178.md). **1.86…1.87** perf waves shipped (shell + navigation). **1.88…1.89** continue the performance arc (**animations stay**). OSK/packaging **2.01+**. **Do not implement 2.00 before 1.90.**  
...
- Thinner delegates under `reuseItems`; document role/model patterns in [performance.md](performance.md)
...
- [performance.md](performance.md): control-level wins summary for the full arc
...
- [ci-smoke.md](ci-smoke.md): note perf timing advisory from the arc
