...
Page {
    id: page
    padding: 0
    // Opaque page surface (Gallery uses Solid window chrome).
    ...
    ScrollView {
        ...
        // Match other gallery pages: ColumnLayout is the ScrollView content.
        // Avoid wrapping in an Item whose height binds to ColumnLayout.implicitHeight
        // while that layout is also anchors-filled — Flow children then fail to
        // contribute height and the flickable thinks content fits the viewport.
        ColumnLayout {
            id: contentCol
