...
Plan: [docs/on-screen-keyboard.md](docs/on-screen-keyboard.md).
...
| **OSK CJK / emoji** | Beyond 1.70 Latin+symbols — [on-screen-keyboard.md](docs/on-screen-keyboard.md) |
...
| [docs/on-screen-keyboard.md](docs/on-screen-keyboard.md) | 1.70 OSK — Keyman Core + our UI |
