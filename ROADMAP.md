...
**Current:** **3.27** (master — dialog queue prune + font Fixedsys hardening)
**Next up:** **3.00** breaking close-out (prep [checkpoint-300](docs/checkpoint-300.md)) · **3.28+** friction-only · [micro-interaction backlog](#micro-interaction--visual-polish--deferred-last)
**Planned through:** **3.10** complete · **3.11–3.12** polish · **3.13–3.27** WinUI basics · **3.00** still open · then friction / micro-interaction
