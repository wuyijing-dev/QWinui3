...
Ladder (engine stays Keyman Core; chrome stays ours): **1.70** en-US OSK → **1.71** extra layouts → **1.72** Chinese IME → **1.73** full IME → **1.74** checkpoint. Plan: [docs/on-screen-keyboard.md](docs/on-screen-keyboard.md).
...
| [docs/on-screen-keyboard.md](docs/on-screen-keyboard.md) | 1.70…1.73 OSK → full in-app IME |
