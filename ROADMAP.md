...
**Current:** **3.15** (master — ProgressBar header / value / WinUI states)
**Next up:** **3.00** breaking close-out (prep [checkpoint-300](docs/checkpoint-300.md)) · **3.16+** friction-only · [micro-interaction backlog](#micro-interaction--visual-polish--deferred-last)
**Planned through:** **3.10** complete · **3.11** L1 · **3.12** L2 · **3.13** Slider · **3.14** RangeSlider · **3.15** ProgressBar · **3.00** still open · then friction / micro-interaction
