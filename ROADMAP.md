...
**Current:** **3.42** (master — Theme singleton trim / lazy font stacks)
**Next up:** **3.43** memory (List/Tree delegate reuse) · **3.00** breaking close-out still open ([checkpoint-300](docs/checkpoint-300.md)) · [tranche 10 → 4.00](#efficiency--control-depth-tranche-10-334--400)
