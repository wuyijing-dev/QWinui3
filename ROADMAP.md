...
**Current:** **3.52** (master — DataTable / TreeDataGrid row-height cache + skip rebuild)
**Next up:** **3.53** silent runtime (NavigationView pane) · **3.00** breaking close-out still open ([checkpoint-300](docs/checkpoint-300.md)) · [tranche 10 → 4.00](#efficiency--control-depth-tranche-10-334--400)
