...
**Current:** **3.45** (master — Chart series ring caps + opt-in downsample)
**Next up:** **3.46** memory (Gallery page unload) · **3.00** breaking close-out still open ([checkpoint-300](docs/checkpoint-300.md)) · [tranche 10 → 4.00](#efficiency--control-depth-tranche-10-334--400)
