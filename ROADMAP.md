...
Still **1.xx**. One theme per `YY`. **1.70…1.74** shipped the GPL-free in-app IME path through soak; **1.75…1.76** finish packs + MIT deepen. Long-horizon checkpoint is **1.77**. Plan: [docs/on-screen-keyboard.md](docs/on-screen-keyboard.md). Chrome stays ours. Keyman Core stays layouts only. No Qt Virtual Keyboard.
