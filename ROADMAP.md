...
**Current:** **3.11** (master — Style primitives polish)
**Next up:** **3.00** breaking close-out (prep [checkpoint-300](docs/checkpoint-300.md)) · **3.12+** friction-only · [micro-interaction backlog](#micro-interaction--visual-polish--deferred-last)
**Planned through:** **3.10** complete · **3.11** L1 baseline shipped · **3.00** still open · then friction / micro-interaction
