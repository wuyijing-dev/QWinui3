...
**Current:** **3.37** (master — Gallery ControlCatalog lazy)
**Next up:** **3.38** cold start (optional hosts deferred) · **3.00** breaking close-out still open ([checkpoint-300](docs/checkpoint-300.md)) · [tranche 10 → 4.00](#efficiency--control-depth-tranche-10-334--400)
