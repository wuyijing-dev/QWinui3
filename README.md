...
**v1.88** · **200+** public controls · Gallery demos for most of them  
**Still 1.xx** — **1.86…1.88** perf waves shipped; **1.89** style/charts wave next ([ROADMAP.md](ROADMAP.md)). Not implementing 2.00 yet.
