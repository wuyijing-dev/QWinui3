...
**v1.87** · **200+** public controls · Gallery demos for most of them  
**Still 1.xx** — **1.86…1.87** perf waves shipped (shell + navigation); **1.88…1.89** continue ([ROADMAP.md](ROADMAP.md)). Not implementing 2.00 yet.
