...
**v1.86** · **200+** public controls · Gallery demos for most of them  
**Still 1.xx** — **1.86** perf wave 1 (shell runtime) shipped; **1.87…1.89** performance arc continues ([ROADMAP.md](ROADMAP.md)). Not implementing 2.00 yet.
