...
**v1.90** · **200+** public controls · Gallery demos for most of them  
**1.xx close-out** — [checkpoint-190.md](docs/checkpoint-190.md) · performance arc **signed off** (1.86…1.89) · **[1.xx freeze ends at 2.00](docs/compatibility-1xx.md)** · next planned major **2.00** ([ROADMAP.md](ROADMAP.md)). Not implementing 2.00 yet.
