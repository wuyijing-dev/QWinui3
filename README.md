...
**v1.78** · **200+** public controls · Gallery demos for most of them  
**Still 1.xx** — long-horizon checkpoint ([docs/checkpoint-178.md](docs/checkpoint-178.md)); prefer field harden / pause vs new surfaces; not drafting 2.00.
