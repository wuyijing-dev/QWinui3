...
**1.xx close-out** — [checkpoint-190.md](docs/checkpoint-190.md) · performance arc **signed off** (1.86…1.89) · **[1.xx freeze ends at 2.00](docs/compatibility-1xx.md)** · planned through **2.20** — next major **2.00** ([ROADMAP.md](ROADMAP.md)).
