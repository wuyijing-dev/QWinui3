...
**v1.89** · **200+** public controls · Gallery demos for most of them  
**Still 1.xx** — **1.86…1.89** performance arc shipped; **1.90** close-out next ([ROADMAP.md](ROADMAP.md)). Not implementing 2.00 yet.
