...
**Still 1.xx** — long-horizon checkpoint ([docs/checkpoint-178.md](docs/checkpoint-178.md)); **1.82** floating OSK + opt-in Windows system-wide; prefer harden / pause vs new surfaces; not drafting 2.00.
